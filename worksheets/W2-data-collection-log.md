...
- **Class:** _______lightgreen__________
...
- **เวลา:** _____ ถึง _____
- **Class:** _______normalgreen__________
- **จำนวน samples ที่เก็บ:** __40ใบ___
- **สภาพแวดล้อม:** _________________
- **ใครเป็น subject?:** _________________
- **Variation ที่ลอง:** _________________
...
- **เวลา:** _____ ถึง _____
- **Class:** _______darkgreen__________
- **จำนวน samples ที่เก็บ:** __40ใบ___
- **สภาพแวดล้อม:** _________________
- **ใครเป็น subject?:** _________________
- **Variation ที่ลอง:** _________________
...
### a) สิ่งที่ยากที่สุด:
```
การที่ไม่รู้ฟังก์ชันในตอนเเรก
```

### b) ถ้าทำใหม่จะปรับอะไร:
```
ปรับรายละเอียดให้ดีขึ้น
```
